...
.method public sendCdmaSms([BLandroid/os/Message;Z)V
    ...
    .line 211
    invoke-virtual {p0, p2}, Lcom/qualcomm/qti/internal/telephony/QtiRIL;->getQtiRadioProxy(Landroid/os/Message;)Lvendor/qti/hardware/radio/qtiradio/V1_0/IQtiRadio;

    move-result-object v0

    .line 212
    .local v0, "radioProxy":Lvendor/qti/hardware/radio/qtiradio/V1_0/IQtiRadio;
    nop
    ...
    .line 214
    .local v1, "radioProxy2_0":Lvendor/qti/hardware/radio/qtiradio/V2_0/IQtiRadio;
    if-eqz v1, :cond_0

    .line 215
    const/16 v2, 0x57

    iget-object v3, p0, Lcom/qualcomm/qti/internal/telephony/QtiRIL;->mRILDefaultWorkSource:Landroid/os/WorkSource;

    invoke-virtual {p0, v2, p2, v3}, Lcom/qualcomm/qti/internal/telephony/QtiRIL;->obtainRequestSerial(ILandroid/os/Message;Landroid/os/WorkSource;)I
    ...
    const-string v5, "] >  RIL_REQUEST_CDMA_SEND_SMS expectMore="
    ...
    .line 222
    .local v3, "msg":Landroid/hardware/radio/V1_0/CdmaSmsMessage;
    invoke-virtual {p0, v3, p1}, Lcom/qualcomm/qti/internal/telephony/QtiRIL;->constructCdmaSendSmsRilRequest(Landroid/hardware/radio/V1_0/CdmaSmsMessage;[B)V

    .line 225
    :try_start_0
    invoke-interface {v1, v2, v3, p3}, Lvendor/qti/hardware/radio/qtiradio/V2_0/IQtiRadio;->sendCdmaSms(ILandroid/hardware/radio/V1_0/CdmaSmsMessage;Z)V

    .line 226
    iget-object v4, p0, Lcom/qualcomm/qti/internal/telephony/QtiRIL;->mMetrics:Lcom/android/internal/telephony/metrics/TelephonyMetrics;

    iget v5, p0, Lcom/qualcomm/qti/internal/telephony/QtiRIL;->mQtiPhoneId:I

    const/4 v6, 0x2

    invoke-virtual {v4, v5, v2, v6, v6}, Lcom/android/internal/telephony/metrics/TelephonyMetrics;->writeRilSendSms(IIII)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v3    # "msg":Landroid/hardware/radio/V1_0/CdmaSmsMessage;
    ...
    const-string v3, "fall back to default sendCdmaSms"
